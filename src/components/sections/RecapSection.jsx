    ...
    <section className="w-full relative">
      <div className="w-full px-4 sm:px-10 lg:px-20 py-12 sm:py-20">
        ...
        <div className="w-full bg-[#FFD8AA] rounded-[40px] sm:rounded-[60px] lg:rounded-[80px] min-h-[600px] lg:h-[700px] relative flex items-center justify-center">
          ...
          {/* Content */}
          <div className="w-full flex flex-col lg:flex-row justify-between items-center gap-12 lg:gap-16 px-4 sm:px-10 lg:px-20 pt-20 sm:pt-32 lg:pt-40">
            {/* Left Text */}
            ...
            <div className="relative w-full max-w-[520px] h-[250px] sm:h-[320px] lg:h-[355px] mx-auto lg:mx-0">
              ...
              <img
                src={firsticon}
                alt="First Icon"
                className="absolute top-[-20px] sm:top-[-25px] lg:top-[-30px] left-[40px] sm:left-[45px] lg:left-[50px] w-13 sm:w-20 lg:w-26 h-auto object-cover"
              />
              <img
                src={secondicon}
                alt="Second Icon"
                className="absolute top-[200px] sm:top-[240px] lg:top-[270px] left-[90px] sm:left-[100px] lg:left-[110px] w-13 sm:w-20 lg:w-26 h-auto object-cover"
              />
              <img
                src={thirdicon}
                alt="Third Icon"
                className="absolute top-[90px] sm:top-[100px] lg:top-[120px] left-[240px] sm:left-[270px] lg:left-[295px] w-13 sm:w-20 lg:w-26 h-auto object-cover"
              />
            </div>
          </div>
        </div>
